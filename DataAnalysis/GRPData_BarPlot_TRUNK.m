...
%% Controls
p1 =errorbar([5 6],[TD_Cond2 TD_Cond5],[SE_Cond2 SE_Cond5],'k','LineWidth',2); % Table restrained vs unrestrained Controls
p2 = plot(5,Individ_Means_2,'s','Color','b','Linewidth',2);
p3 = plot(6,Individ_Means_5,'s','Color','b','Linewidth',2);
%% Stroke - Paretic
p4 =errorbar([1 2],[TD_Cond2 TD_Cond5],[SE_Cond2 SE_Cond5],'k','LineWidth',2); % Table restrained vs unrestrained Controls
...
p6 = plot(2,Individ_Means_5,'s','Color',[0.4940 0.1840 0.5560],'Linewidth',2);
 %% Stroke - Non Paretic
p7 =errorbar([3 4],[TD_Cond2 TD_Cond5],[SE_Cond2 SE_Cond5],'k','LineWidth',2); % Table restrained vs unrestrained Controls
p8 = plot(3,Individ_Means_2,'s','Color',[0.9290 0.6940 0.1250],'Linewidth',2);
p9 = plot(4,Individ_Means_5,'s','Color',[0.9290 0.6940 0.1250],'Linewidth',2);
...
ylim([0 6])
title('Trunk Displacement-25% MVT','FontSize',28)
