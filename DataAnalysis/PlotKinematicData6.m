...
axis equal
title('Trunk Coordinate Systems and BLS at Start and End of Reach','FontSize',16.67)
xlabel('X axis')
ylabel('Y axis')
zlabel('Z axis')
...
% axis equal
% 
% title('Scapular BLs and Coordinate Systems at Start and End of Reach','FontSize',16)
% xlabel('X Axis')
% ylabel('Y Axis')
% zlabel('Z Axis')
