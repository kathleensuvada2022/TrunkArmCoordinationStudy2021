...
[ScapCoord_Marker TrunkCS_marker] = BL_markerCS(BLs{1,2},BLs{1,1},partid,hand);

setup.BoneCSinMarker{1,2} = ScapCoord_Marker; %Replacing with Correct CS (Updated July 2022)- Incorrect in saved FILE!
setup.BoneCSinMarker{1,1} = TrunkCS_marker; 
...
'NOTE: BLs DURING DIGITIZATION NOT TRIAL'
