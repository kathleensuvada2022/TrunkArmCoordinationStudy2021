function main(timerObject)
% MAIN Brief description of GUI.
%       Comments displayed at the command line in response 
%       to the help command. 

% (Leave a blank line following the help.)

if ~exist('timerObject','var')
    disp('Please run the make.m file in order to run this program');
    return;
end
...
% AMA - This function only sets up the figure names and sizes
