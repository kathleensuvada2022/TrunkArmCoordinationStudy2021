...
%changes made by Kacey, Ahalya on 10.02.19 to have a sequence of channels
%used from Channel #6 onwards 
myhandles.Channels = 6:6+myhandles.nChan-1; % Channel list for DAQ
