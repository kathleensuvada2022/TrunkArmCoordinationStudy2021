...
hold on
plot3(BL{1,1}(1),BL{1,1}(2),BL{1,1}(3),'-o','Color','b','MarkerSize',10,...
    'MarkerFaceColor','#D9FFFF')
text(BL{1,1}(1),BL{1,1}(2),BL{1,1}(3),BLnames(1),'FontSize',12)
...
hold on
plot3(BL_bone{1,1}(1),BL_bone{1,1}(2),BL_bone{1,1}(3),'-o','Color','b','MarkerSize',10,...
    'MarkerFaceColor','#D9FFFF')
text(BL_bone{1,1}(1),BL_bone{1,1}(2),BL_bone{1,1}(3),BLnames(1),'FontSize',12)
