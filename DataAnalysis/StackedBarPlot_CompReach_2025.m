...
figure;
barHandle = bar(xLabels, avgValues, 'stacked');
hold on;
...
text(1.5, yLimits(2) * 0.97, 'Controls', 'HorizontalAlignment', 'center', 'FontSize', 35, 'FontWeight', 'bold');
text(3.5, yLimits(2) * 0.97, 'Non-Paretic', 'HorizontalAlignment', 'center', 'FontSize', 35, 'FontWeight', 'bold');
text(5.5, yLimits(2) * 0.97, 'Paretic', 'HorizontalAlignment', 'center', 'FontSize', 35, 'FontWeight', 'bold');

% Customize plot
ylabel('Reach (%LL)', 'FontSize', 35);
%legend({'Arm', 'Trunk', 'Shoulder'}, 'Location', 'Best', 'FontSize', 30);
title('Composition of Reach', 'FontSize', 40);

% Adjust font size for axes
ax = gca;
ax.FontSize = 35;  % Set font size for the entire axis
