...
%  KCS 2.9.21 -- don't need this? function?
...
% end
%% 
% robotics.internal.normalizeRows file

% Normalize and transpose the quaternions
% q = robotics.internal.normalizeRows(q).';

%from  normalize rows in robotics tool box
...
%Checking if single double real 3d size... not sure what line 110 does
%since 2014 doesn't recognize rotm2tofrm
validateattributes(R, {'single','double'}, {'nonempty', ...
    'real','3d','size',[3 3 NaN],}, ...
    'rotm2tform', 'R'); 
