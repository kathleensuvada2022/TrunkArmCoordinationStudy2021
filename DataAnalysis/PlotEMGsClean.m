...
hold on
line(lax1,'Color','b','Xdata',[.5 .5],'Ydata',[-0.1 .4], 'LineWidth',.7); % start reach
...
%Adding Vertical Line Time points 
line('Color','m','Xdata',[timevelmax timevelmax],'Ydata',[-0.1 .4],'LineWidth',.7); % max vel
line('Color','c','Xdata',[timedistmax timedistmax],'Ydata',[-0.1 .4],'LineWidth',.7); %max, dist
line('Color','g','Xdata',[timeend timeend],'Ydata',[-0.1 .4],'LineWidth',.7); %endreach
