%% RTIS2010 Redigitization 2023 Data
...
% Make Sure to load in proper BL file where Humerus BLs are in the Forearm
% CS
...
title('Forearm & Humerus BLs with Forearm Bone CS in Forearm Marker Frame 2023','FontSize',24)
